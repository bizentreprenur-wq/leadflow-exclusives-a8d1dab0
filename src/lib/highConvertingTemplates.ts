...
export const HIGH_CONVERTING_TEMPLATES: EmailTemplate[] = [
  ...
  },
  {
    ...
    conversionTip: 'Relaxing visuals and easy booking are key',
    body_html: createMinimalistTemplate({
      heroImage: IMAGES.spa,
      accentColor: '#7c3aed',
      headline: 'Your Clients Want to Book Online',
      body: "{{first_name}}, 80% of spa clients prefer booking online. If {{business_name}} doesn't offer a beautiful website with instant booking, you're losing clients to competitors who make it effortless.",
      features: ['Online booking system', 'Service menu with descriptions', 'Gift card purchases', 'Photo gallery of your space'],
      cta: 'Fill Your Appointment Book →'
    }),
  },
  {
    id: 'ls-spa-2',
    name: 'Spa - Luxury Experience',
    category: 'local-services' as const,
    industry: 'Spa & Wellness',
    subject: '✨ {{business_name}} - First impressions start online',
    description: 'Premium spa experience template',
    previewImage: IMAGES.spa,
    conversionTip: 'Emphasize the relaxation experience',
    body_html: createNeonTemplate({
      heroImage: IMAGES.spa,
      accentColor: '#a855f7',
      headline: "{{first_name}}, Your Spa Experience Starts Online",
      body: "Clients choose spas based on ambiance and reviews. {{business_name}} deserves a website that captures your serene atmosphere and makes booking irresistible.",
      features: ['Virtual tour of facilities', 'Treatment descriptions', 'Membership packages', 'Client transformation stories'],
