...
const IMAGES = {
  ...
  webDesignCompetitor: "/placeholder.svg",
  ...
  // Home services industry images
  mechanic: "https://images.unsplash.com/photo-1619642751034-765dfdf7c58e?w=600&h=300&fit=crop",
  spa: "https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=600&h=300&fit=crop",
...
export const HIGH_CONVERTING_TEMPLATES: EmailTemplate[] = [
  ...
  // ===== HOME SERVICES INDUSTRY TEMPLATES =====
  {
    ...
    subject: '🔧 {{business_name}} - 73% of car owners search online first',
    description: 'For auto mechanics and repair shops',
    previewImage: IMAGES.mechanic,
    conversionTip: 'Trust and transparency win in auto repair',
    body_html: createClassicHeroTemplate({
      heroImage: IMAGES.mechanic,
      accentColor: '#dc2626',
      headline: 'Car Owners Google Before They Call',
      body: "{{first_name}}, 73% of car owners search online before choosing a mechanic. If {{business_name}} doesn't have a professional website with reviews and pricing transparency, you're losing customers to shops that do.",
      features: ['Online appointment booking', 'Service menu with pricing', 'Customer reviews display', 'Before/after repair photos'],
      cta: 'Get More Repair Jobs →'
    }),
  },
  {
    id: 'ls-mechanic-2',
    name: 'Mechanic - Trust Builder',
    category: 'local-services' as const,
    industry: 'Auto Mechanic',
    subject: '{{business_name}} - Customers check reviews before booking repairs',
    description: 'Trust-focused template for auto repair shops',
    previewImage: IMAGES.mechanic,
    conversionTip: 'Highlight certifications and warranties',
    body_html: createGradientTemplate({
      heroImage: IMAGES.mechanic,
      accentColor: '#b91c1c',
      headline: "{{first_name}}, Trust Is Everything in Auto Repair",
      body: "Car owners are skeptical — they've all heard horror stories about mechanics. {{business_name}} needs a website that builds instant trust with certifications, warranties, and honest pricing upfront.",
      features: ['ASE certification badges', 'Warranty information', 'Transparent pricing', 'Real customer testimonials'],
      cta: 'Build Customer Trust →'
    }),
  },
  {
    id: 'ls-mechanic-3',
    name: 'Mechanic - Fleet Services',
    category: 'local-services' as const,
    industry: 'Auto Mechanic',
    subject: '🚗 {{business_name}} - Fleet managers search for reliable mechanics online',
    description: 'Fleet and commercial vehicle focused template for auto repair shops',
    previewImage: IMAGES.mechanic,
    conversionTip: 'Fleet contracts provide recurring revenue — showcase fleet capabilities',
    body_html: createMagazineTemplate({
      heroImage: IMAGES.mechanic,
      accentColor: '#e11d48',
      headline: "{{first_name}}, Win Fleet & Commercial Contracts",
      body: "Fleet managers and small business owners need reliable, fast turnaround mechanics. {{business_name}} can land recurring commercial contracts by showcasing fleet service capabilities, pickup/delivery, and priority scheduling online.",
      features: ['Fleet maintenance programs', 'Priority scheduling for businesses', 'Pickup & delivery service', 'Detailed digital inspection reports'],
      cta: 'Land Fleet Contracts →'
    }),
  },
  {
    id: 'ls-spa-1',
    name: 'Day Spa - Relaxation',
    category: 'local-services' as const,
    industry: 'Day Spa',
    subject: '🧖 {{business_name}} - Spa clients book online 80% of the time',
    description: 'For day spas focused on relaxation, massages, facials, and non-invasive beauty treatments',
    previewImage: IMAGES.spa,
    conversionTip: 'Relaxing visuals and easy online booking convert best for day spas',
    body_html: createMinimalistTemplate({
      heroImage: IMAGES.spa,
      accentColor: '#7c3aed',
      headline: 'Your Clients Want to Book Relaxation Online',
      body: "{{first_name}}, 80% of spa clients prefer booking online. If {{business_name}} doesn't offer a beautiful website with instant booking for massages, facials, and body treatments — you're losing clients to spas that make it effortless.",
      features: ['Online booking for all treatments', 'Service menu with prices & durations', 'Gift card & package purchases', 'Photo gallery of your tranquil space'],
      cta: 'Fill Your Appointment Book →'
    }),
  },
  {
    id: 'ls-spa-2',
    name: 'Day Spa - Luxury Experience',
    category: 'local-services' as const,
    industry: 'Day Spa',
    subject: '✨ {{business_name}} - First impressions start online',
    description: 'Premium day spa template emphasizing luxury relaxation experience',
    previewImage: IMAGES.spa,
    conversionTip: 'Emphasize the calming atmosphere and escape from everyday stress',
    body_html: createNeonTemplate({
      heroImage: IMAGES.spa,
      accentColor: '#a855f7',
      headline: "{{first_name}}, Your Spa Experience Starts Online",
      body: "Clients choose day spas based on ambiance and reviews. {{business_name}} deserves a website that captures your serene atmosphere — the aromatherapy, hot stone massages, and rejuvenating facials — making booking irresistible.",
      features: ['Virtual tour of facilities', 'Treatment descriptions & benefits', 'Membership & loyalty packages', 'Client relaxation stories & reviews'],
      cta: 'Attract Premium Clients →'
    }),
  },
  {
    id: 'ls-spa-3',
    name: 'Day Spa - Wellness Packages',
    category: 'local-services' as const,
    industry: 'Day Spa',
    subject: '🌿 {{business_name}} - Wellness seekers spend $120+ per visit',
    description: 'Package-focused day spa template for upselling treatments',
    previewImage: IMAGES.spa,
    conversionTip: 'Highlight wellness packages to increase average ticket value',
    body_html: createMagazineTemplate({
      heroImage: IMAGES.spa,
      accentColor: '#059669',
      headline: "Turn First-Time Visitors Into Loyal Wellness Members",
      body: "{{first_name}}, the average spa client spends $120+ per visit — but only if they can easily discover and book packages. {{business_name}} needs a website that showcases couples packages, seasonal specials, and membership deals to maximize every booking.",
      features: ['Couples & group packages', 'Seasonal wellness specials', 'Monthly membership plans', 'Add-on treatment upsells'],
      cta: 'Boost Your Revenue →'
    }),
  },
  {
    id: 'ls-medspa-1',
    name: 'MedSpa - Cosmetic Treatments',
    category: 'local-services' as const,
    industry: 'Medical Spa',
    subject: '💉 {{business_name}} - 67% of medspa clients research treatments online first',
    description: 'For medical spas offering Botox, fillers, laser treatments, and advanced cosmetic procedures',
    previewImage: IMAGES.spa,
    conversionTip: 'Credentials and before/after results drive medspa conversions',
    body_html: createGradientTemplate({
      heroImage: IMAGES.spa,
      accentColor: '#be185d',
      headline: "{{first_name}}, MedSpa Clients Research Before They Book",
      body: "67% of medspa clients research treatments, compare providers, and read reviews online before choosing. If {{business_name}} doesn't showcase your medical credentials, before/after photos, and treatment results — they'll book with a competitor who does.",
      features: ['Before & after photo gallery', 'Physician credentials & certifications', 'Treatment pricing transparency', 'Online consultation booking'],
      cta: 'Attract More MedSpa Clients →'
    }),
  },
  {
    id: 'ls-medspa-2',
    name: 'MedSpa - Trust & Credentials',
    category: 'local-services' as const,
    industry: 'Medical Spa',
    subject: '🏥 {{business_name}} - Patients want to see your credentials online',
    description: 'Trust-building template for medical spas emphasizing medical expertise and safety',
    previewImage: IMAGES.spa,
    conversionTip: 'Medical credentials and safety protocols build trust for advanced procedures',
    body_html: createSplitLayoutTemplate({
      heroImage: IMAGES.spa,
      accentColor: '#9333ea',
      headline: "Trust Is Everything in Medical Aesthetics",
      body: "{{first_name}}, patients considering Botox, fillers, laser resurfacing, or body contouring need to trust the provider. {{business_name}} needs a website that highlights your medical director, board certifications, FDA-approved devices, and patient safety protocols.",
      features: ['Board-certified physician profiles', 'FDA-approved device certifications', 'Patient safety & privacy protocols', 'Real patient testimonial videos'],
      cta: 'Build Patient Confidence →'
    }),
  },
  {
    id: 'ls-medspa-3',
    name: 'MedSpa - Treatment Specials',
    category: 'local-services' as const,
    industry: 'Medical Spa',
    subject: '✨ {{business_name}} - New patient specials drive 3x more bookings',
    description: 'Promotional template for medical spa treatment packages and new patient offers',
    previewImage: IMAGES.spa,
    conversionTip: 'New patient specials and treatment bundles increase first-time bookings by 3x',
    body_html: createCardGridTemplate({
      heroImage: IMAGES.spa,
      accentColor: '#c026d3',
      headline: "{{first_name}}, Turn Browsers Into Booked Patients",
      body: "MedSpa clients compare prices and packages across providers. {{business_name}} can win more first-time patients with a website that features treatment bundles, new patient specials, and financing options upfront.",
      features: ['New patient welcome packages', 'Treatment bundle pricing', 'Financing & payment plans', 'Seasonal promotional offers', 'Free consultation booking'],
      cta: 'Launch Your Specials Page →'
    }),
  },
  {
    id: 'ls-electrician-1',
    ...
    subject: '⚡ {{business_name}} - Homeowners search "electrician near me" 500K+ times/month',
    description: 'For electricians and electrical contractors',
    previewImage: IMAGES.electrician,
    conversionTip: 'Safety credentials and emergency availability win jobs',
    body_html: createSplitLayoutTemplate({
      heroImage: IMAGES.electrician,
      accentColor: '#f59e0b',
      headline: "Homeowners Need an Electrician They Can Trust",
      body: "{{first_name}}, when someone has an electrical emergency, they Google first. If {{business_name}} doesn't show up with a professional website, licensed credentials, and quick contact — they'll call someone else.",
      features: ['Emergency service highlights', 'License & insurance badges', 'Service area coverage', 'Instant quote request form'],
      cta: 'Get More Service Calls →'
    }),
  },
  {
    id: 'ls-electrician-2',
    name: 'Electrician - Commercial',
    category: 'local-services' as const,
    industry: 'Electrician',
    subject: '{{business_name}} - Commercial clients research contractors online',
    description: 'For commercial electrical contractors',
    previewImage: IMAGES.electrician,
    conversionTip: 'Showcase commercial project portfolio',
    body_html: createCardGridTemplate({
      heroImage: IMAGES.electrician,
      accentColor: '#d97706',
      headline: "{{first_name}}, Win More Commercial Contracts",
      body: "Property managers and GCs check your online presence before calling. {{business_name}} needs a website that showcases your commercial projects, certifications, and capacity.",
      features: ['Project portfolio gallery', 'Commercial certifications', 'Safety record display', 'Free estimate requests'],
      cta: 'Land Bigger Jobs →'
    }),
  },
  {
    id: 'ls-electrician-3',
    name: 'Electrician - Smart Home',
    category: 'local-services' as const,
    industry: 'Electrician',
    subject: '🏠 {{business_name}} - Smart home installs are a $150B market',
    description: 'Smart home and modern electrical services template',
    previewImage: IMAGES.electrician,
    conversionTip: 'Position as a modern tech-savvy electrician to command premium pricing',
    body_html: createTimelineTemplate({
      heroImage: IMAGES.electrician,
      accentColor: '#ea580c',
      headline: "{{first_name}}, Smart Homes Need Smart Electricians",
      body: "Homeowners are spending billions on smart home upgrades — lighting, EV chargers, solar panels, and home automation. {{business_name}} can tap into this premium market with a website that positions you as a modern, tech-forward electrician.",
      features: ['EV charger installation', 'Smart lighting & automation', 'Solar panel wiring', 'Whole-home surge protection'],
      cta: 'Enter the Smart Home Market →'
    }),
  },
  {
    id: 'ls-roofer-1',
    ...
    category: 'local-services' as const,
    industry: 'Roofing',
    subject: '🏠 {{business_name}} - Homeowners get 3 quotes online before calling a roofer',
    description: 'For roofing contractors and companies',
    previewImage: IMAGES.roofer,
    conversionTip: 'Before/after photos and financing options close deals',
    body_html: createClassicHeroTemplate({
      heroImage: IMAGES.roofer,
      accentColor: '#059669',
      headline: "Homeowners Compare Roofers Online",
      body: "{{first_name}}, homeowners get an average of 3 quotes before choosing a roofer. If {{business_name}} doesn't have a professional website with project photos, reviews, and easy contact — you're not even in the running.",
      features: ['Before/after project gallery', 'Financing options displayed', 'Storm damage assessment form', 'Insurance claim assistance info'],
      cta: 'Win More Roofing Jobs →'
    }),
  },
  {
    id: 'ls-roofer-2',
    name: 'Roofer - Storm Season',
    category: 'local-services' as const,
    industry: 'Roofing',
    subject: '🌧️ {{business_name}} - Storm season means roof searches spike 400%',
    description: 'Storm-season focused roofing template',
    previewImage: IMAGES.roofer,
    conversionTip: 'Urgency + emergency availability drives conversions',
    body_html: createTimelineTemplate({
      heroImage: IMAGES.roofer,
      accentColor: '#047857',
      headline: "{{first_name}}, Storm Season Is Your Biggest Opportunity",
      body: "Roof repair searches spike 400% after storms. {{business_name}} needs a website that ranks for emergency terms and converts panicked homeowners into booked jobs — fast.",
      features: ['Emergency repair request form', '24/7 availability badge', 'Insurance filing help', 'Free roof inspection offer'],
      cta: 'Capture Storm Leads →'
    }),
  },
  {
    id: 'ls-roofer-3',
    name: 'Roofer - New Construction',
    category: 'local-services' as const,
    industry: 'Roofing',
    subject: '🏗️ {{business_name}} - Builders need reliable roofing partners',
    description: 'New construction and builder partnership roofing template',
    previewImage: IMAGES.roofer,
    conversionTip: 'Builder partnerships provide steady high-volume work',
    body_html: createSplitLayoutTemplate({
      heroImage: IMAGES.roofer,
      accentColor: '#065f46',
      headline: "{{first_name}}, Partner With Builders for Steady Work",
      body: "General contractors and home builders need dependable roofing partners who deliver on time, every time. {{business_name}} can land builder contracts with a website that showcases your project capacity, material partnerships, and on-time track record.",
      features: ['Builder partnership program', 'Material supplier certifications', 'Project timeline guarantees', 'Volume pricing for developments'],
      cta: 'Win Builder Contracts →'
    }),
  },
  {
    id: 'ls-home-services-1',
    name: 'Home Services - General',
    category: 'local-services' as const,
    industry: 'Home Services',
    subject: '🏡 {{business_name}} - 97% of homeowners search online for home services',
    description: 'For general home service providers (handyman, remodeling, etc.)',
    previewImage: IMAGES.homeServices,
    conversionTip: 'Showcase range of services and reliability',
    body_html: createGradientTemplate({
      heroImage: IMAGES.homeServices,
      accentColor: '#2563eb',
      headline: "Homeowners Want Reliable Help — Online",
      body: "{{first_name}}, 97% of homeowners research home service providers online before making a call. {{business_name}} needs a professional website that showcases your services, reviews, and availability.",
      features: ['Full service menu', 'Online booking & estimates', 'Customer reviews & ratings', 'Service area map'],
      cta: 'Get More Home Jobs →'
    }),
  },
  {
    id: 'ls-home-services-2',
    name: 'Home Services - Premium',
    category: 'local-services' as const,
    industry: 'Home Services',
    subject: '{{business_name}} - Stand out from every handyman on Craigslist',
    description: 'Premium positioning for home service companies',
    previewImage: IMAGES.homeServices,
    conversionTip: 'Professional branding differentiates from DIY competitors',
    body_html: createNeonTemplate({
      heroImage: IMAGES.homeServices,
      accentColor: '#1d4ed8',
      headline: "{{first_name}}, Look Professional. Win Professional Jobs.",
      body: "Most home service providers look the same online — if they exist at all. {{business_name}} can stand out with a professional website that builds trust instantly and converts visitors into paying customers.",
      features: ['Professional portfolio', 'Licensed & insured badges', 'Instant quote calculator', 'Satisfaction guarantee display'],
      cta: 'Upgrade Your Image →'
    }),
  },
  {
    id: 'ls-home-services-3',
    name: 'Home Services - Seasonal',
    category: 'local-services' as const,
    industry: 'Home Services',
    subject: '📅 {{business_name}} - Seasonal demand peaks mean big revenue opportunities',
    description: 'Seasonal marketing template for home service companies',
    previewImage: IMAGES.homeServices,
    conversionTip: 'Seasonal campaigns capture demand spikes and fill slow periods',
    body_html: createMagazineTemplate({
      heroImage: IMAGES.homeServices,
      accentColor: '#7c3aed',
      headline: "{{first_name}}, Capture Every Seasonal Opportunity",
      body: "Home service demand swings with the seasons — spring cleaning, summer AC, fall gutters, winter heating. {{business_name}} needs a website that promotes seasonal specials automatically and captures leads during every peak.",
      features: ['Seasonal service promotions', 'Automated email campaigns', 'Pre-season booking discounts', 'Year-round maintenance plans'],
      cta: 'Never Miss a Season →'
    }),
  },
];
