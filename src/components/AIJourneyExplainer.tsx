  ...
  const journeyStages: JourneyStage[] = [
    {
      ...
      description: "When a user searches for leads using GMB Scanner or Platform Scanner",
      aiFeatures: [
        {
      ...
      <CardContent className="space-y-6">
        ...
        {currentStage && (
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              {currentStage.aiFeatures.map((feature, i) => (
                <div 
                  key={i}
        ...
        <div className="p-4 rounded-xl bg-gradient-to-r from-primary/10 to-accent/10 border border-primary/30">
          <h4 className="font-bold mb-2 flex items-center gap-2">
            ...
            Summary: 8 AI Features Across 7 Journey Stages
          </h4>
          <p className="text-sm text-muted-foreground">
