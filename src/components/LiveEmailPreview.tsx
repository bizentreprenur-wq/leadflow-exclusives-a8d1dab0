...
export default function LiveEmailPreview({
  ...
  const isHtmlEmail = body.includes('<') && body.includes('>') && (
    body.includes('<table') || 
    body.includes('<div') || 
  ...
  // Personalize placeholders for preview
  ...
  return (
    <div className="rounded-xl border-2 border-border overflow-hidden bg-background shadow-lg">
      ...
      >
        {isHtmlEmail ? (
          // Render full HTML email in iframe for accurate preview
          <div className={cn(
            "w-full",
            ...
            <iframe
              ...
              style={{ 
                height: device === "mobile" ? '500px' : '550px',
                minHeight: '400px',
              }}
              title="Email Preview"
          ...
          <div className={cn(
            ...
            <div className={cn(
              ...
              <div className="flex items-center gap-2 text-xs">
                ...
                <span className={isDark ? "text-zinc-200" : "text-gray-700"}>recipient@example.com</span>
              </div>
            </div>
            ...
            <ScrollArea className="h-[450px]">
              <div className={cn("p-5", isDark ? "text-zinc-100" : "text-zinc-900")}>
                ...
                <h2 className={cn(
                  ...
                  {personalizeContent(subject) || "Enter your subject line..."}
                </h2>
                ...
                <div className={cn(
                  ...
                  {formatPlainTextBody(personalizeContent(body)) || (
                    <div className={cn(
                      "text-center py-8",
