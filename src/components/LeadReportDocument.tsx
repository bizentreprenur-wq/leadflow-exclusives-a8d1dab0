        ...
        <ScrollArea className="flex-1 print:overflow-visible">
          <div ref={documentRef} className="p-10 bg-white min-h-full">
            ...
            <div className="text-center mb-10 pb-8 border-b-2 border-gray-200">
              ...
              <p className="text-base text-gray-400 mt-2">{today}</p>
            </div>

            {/* Summary Stats */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-5 mb-10">
              <div className="bg-gray-50 rounded-xl p-5 text-center">
                <div className="text-4xl font-bold text-gray-900">{leads.length}</div>
                <div className="text-base text-gray-500 mt-1">Total Leads</div>
              </div>
              <div className="bg-red-50 rounded-xl p-5 text-center">
                ...
                <div className="text-base text-red-500 mt-1">Hot Leads</div>
              </div>
              <div className="bg-orange-50 rounded-xl p-5 text-center">
                ...
                <div className="text-base text-orange-500 mt-1">Warm Leads</div>
              </div>
              <div className="bg-blue-50 rounded-xl p-5 text-center">
                ...
                <div className="text-base text-blue-500 mt-1">Cold Leads</div>
              </div>
            </div>
